...
Texture2D background;    // Declare variable to hold the background image texture
...
void InitGame(void)
{
    ...
    bgMusic = LoadMusicStream("C:/Users/Akhil/Desktop/Akhil/Amrita University/Semesters/Semester - III/Procedural Programming Using C/Projects/Wall Breaker!/src/Littleroot Town.ogg"); // Use global bgMusic
    ...
    background = LoadTexture("C:/Users/Akhil/Desktop/Akhil/Amrita University/Semesters/Semester - III/Procedural Programming Using C/Projects/Wall Breaker!/src/background_image.png");  // Adjust the path if necessary
    heartImage = LoadTexture("C:/Users/Akhil/Desktop/Akhil/Amrita University/Semesters/Semester - III/Procedural Programming Using C/Projects/Wall Breaker!/src/heart.png");  // Replace with your actual path to the heart image
    // Load brick textures
    brickTexture1 = LoadTexture("C:/Users/Akhil/Desktop/Akhil/Amrita University/Semesters/Semester - III/Procedural Programming Using C/Projects/Wall Breaker!/src/brick1.png");  // Replace with your actual path to brick1 image
    brickTexture2 = LoadTexture("C:/Users/Akhil/Desktop/Akhil/Amrita University/Semesters/Semester - III/Procedural Programming Using C/Projects/Wall Breaker!/src/brick2.png");  // Replace with your actual path to brick2 image
    ballTexture = LoadTexture("C:/Users/Akhil/Desktop/Akhil/Amrita University/Semesters/Semester - III/Procedural Programming Using C/Projects/Wall Breaker!/src/ball.png");  // Replace with your actual path to ball image
    brickBreakSound = LoadSound("C:/Users/Akhil/Desktop/Akhil/Amrita University/Semesters/Semester - III/Procedural Programming Using C/Projects/Wall Breaker!/src/brick_break.ogg");  // Replace with the path to your sound file
...
void DrawGame(void)
{
    BeginDrawing();
        ...
        DrawTexturePro(background, (Rectangle){ 0, 0, background.width, background.height },
                       destRect, (Vector2){ 0, 0 }, 0.0f, WHITE);  // No rotation
        }
        ...
        if (!gameOver)
        {
            ...
            float roundness = 1.0f;  // Adjust for desired roundness
            ...
            for (int i = 0; i < LINES_OF_BRICKS; i++)
            {
                for (int j = 0; j < BRICKS_PER_LINE; j++)
                {
                    if (brick[i][j].active)
                    {
                        // You can alternate brick textures here or choose based on conditions
...
void UnloadGame(void)
{
    ...
    CloseAudioDevice(); // Shuts down the audio system
}
